...
// RabbitmqMock is an autogenerated mock type for the RabbitmqMock type
type RabbitmqMock struct {
	mock.Mock
}

// Channel provides a mock function with given fields:
func (_m *RabbitmqMock) Channel() (harego.Channel, error) {
	ret := _m.Called()
...
func (_m *RabbitmqMock) Close() error {
	ret := _m.Called()
...
func (_m *RabbitmqMock) Consume(queue string, consumer string, autoAck bool, exclusive bool, noLocal bool, noWait bool, args amqp.Table) (<-chan amqp.Delivery, error) {
...
func (_m *RabbitmqMock) ExchangeDeclare(name string, kind string, durable bool, autoDelete bool, internal bool, noWait bool, args amqp.Table) error {
...
func (_m *RabbitmqMock) Publish(exchange string, key string, mandatory bool, immediate bool, msg amqp.Publishing) error {
...
func (_m *RabbitmqMock) Qos(prefetchCount int, prefetchSize int, global bool) error {
...
func (_m *RabbitmqMock) QueueBind(name string, key string, exchange string, noWait bool, args amqp.Table) error {
...
func (_m *RabbitmqMock) QueueDeclare(name string, durable bool, autoDelete bool, exclusive bool, noWait bool, args amqp.Table) (amqp.Queue, error) {
